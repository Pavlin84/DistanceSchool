    ...
    public partial class ExpandDb : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SchoolDisciplines", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SchoolDisciplines_Disciplines_DisciplineId",
                        column: x => x.DisciplineId,
                        principalTable: "Disciplines",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SchoolDisciplines_Schools_SchoolId",
                        column: x => x.SchoolId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ApplicationDocumentsPath = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SchoolId = table.Column<int>(type: "int", nullable: false),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedOn = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Candidacies_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Candidacies_Schools_SchoolId",
                        column: x => x.SchoolId,
                        principalTable: "Schools",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Candidacies_Teams_TeamId",
                        column: x => x.TeamId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TeacherTeams_Disciplines_DisciplineId",
                        column: x => x.DisciplineId,
                        principalTable: "Disciplines",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TeacherTeams_Teachers_TeacherId",
                        column: x => x.TeacherId,
                        principalTable: "Teachers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TeacherTeams_Teams_TeamId",
                        column: x => x.TeamId,
                        principalTable: "Teams",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Candidacies_ApplicationUserId",
                table: "Candidacies",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Candidacies_IsDeleted",
                table: "Candidacies",
                column: "IsDeleted");

            migrationBuilder.CreateIndex(
                name: "IX_Candidacies_SchoolId",
                table: "Candidacies",
                column: "SchoolId");

            migrationBuilder.CreateIndex(
                name: "IX_Candidacies_TeamId",
                table: "Candidacies",
                column: "TeamId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SchoolDisciplines_DisciplineId",
                table: "SchoolDisciplines",
                column: "DisciplineId");

            migrationBuilder.CreateIndex(
                name: "IX_SchoolDisciplines_SchoolId",
                table: "SchoolDisciplines",
                column: "SchoolId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TeacherTeams_DisciplineId",
                table: "TeacherTeams",
                column: "DisciplineId");

            migrationBuilder.CreateIndex(
                name: "IX_TeacherTeams_IsDeleted",
                table: "TeacherTeams",
                column: "IsDeleted");

            migrationBuilder.CreateIndex(
                name: "IX_TeacherTeams_TeacherId",
                table: "TeacherTeams",
                column: "TeacherId");
